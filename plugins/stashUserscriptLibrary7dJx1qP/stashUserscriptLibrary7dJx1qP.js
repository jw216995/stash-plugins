(function () {
    ...
    const stash = function () {
        ...
        window.fetch = async (...args) => {
            ...
            if (contentType && (contentType.indexOf("application/json") !== -1 || contentType.indexOf("application/graphql-response+json") !== -1) && typeof resource === "string" && resource.endsWith('/graphql')) {                try {
